...
})({"iIzEH":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "bd309b62bcf720b5";
"use strict";
...
},{}],"8RnLm":[function(require,module,exports) {
...
let familyAVG = [];
function render() {
    for(let i = 0; i < data[2]["data"].length; i++)//boucle pour récupérer toutes les familles
    if (family.indexOf(data[2]["data"][i]["family"]) == -1) //indexOf == -1 pour vérif si la valeur est dans le tableau
    ...
    for(let j = 0; j < family.length; j++){
        ...
        for(let k = 0; k < data[2]["data"].length; k++)//boucle qui parcour les data
    ...
    (async function() {
        new (0, _auto.Chart)(document.getElementById("problemes"), {
            type: "bar",
            data: {
                labels: famille,
                datasets: [
                    {
                        label: "Temps moyen de r\xe9solution en seconde",
                        data: tempsMoyen
                    }
                ]
            }
...
},{"chart.js/auto":"d8NN9"}]},["iIzEH","8RnLm"], "8RnLm", "parcelRequire30ab")

//# sourceMappingURL=problemes.bcf720b5.js.map
